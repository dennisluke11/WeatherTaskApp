    ...
    fun AddTaskDialog(
        ...
        AlertDialog(
            ...
            title = { Text(if (task == null) context.getString(R.string.new_task_title) else context.getString(R.string.edit_task_title)) },
            text = {
            ...
            confirmButton = {
                Button(onClick = {
                    ...
                    Text(if (task == null) context.getString(R.string.add_button) else context.getString(R.string.update_button))
                }
            },
            dismissButton = {
